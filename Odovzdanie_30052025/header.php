...
<div class="nav-wrapper">
    <div class="header-wr">
        ...
        <div class="top-bar">
            ...
            <div class="icons">
                <a href="{{ route('user') }}"><img class="icons-img" src="/public/images/user.png" alt="User"></a>
                <a href="{{ route('wishlist') }}"><img class="icons-img" src="/public/images/fav.png"  alt="favourites"></a>
                <img class="icons-img" src="/public/images/pin.png"  alt="location">
                <a href="{{ route('shoppingcart') }}"><img class="icons-img" src="/public/images/shopCart.png"  alt="shopping-cart"></a>
            </div>
        </div>
        ...
        <nav class="navbar">
            ...
            <div class="search-container">
                ...
                <label for="search-turn" class="search-icon">
                    <img class="icons-img" src="/public/images/search.png" alt="Search Icon">
                </label>
